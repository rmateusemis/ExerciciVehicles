...
function addWheels() {
    while (wheels.length < 4) {
        var brand = prompt("Introduce la marca de la rueda");
        var diameter = parseFloat(prompt("Introduce el diámetro de la rueda (Entre 0'4 y 2)"));
    ...
    console.log(car);
    var pWheel = document.querySelector('#pWheel1 span');
    //let pBrand = document.querySelector('#pBrand1 span');
    //let pDiameter = document.querySelector('#pDiameter1 span');
    for (var i = 0; i < wheels.length; i++) { //¿como imprimir cada iteracion en una columna?
